...
fn function<'gc>(
    ...
    let qname = QName::new(Namespace::package(package, activation.context.gc_context), name);
...
pub fn load_player_globals<'gc>(
    ...
    avm2_system_class!(boolean, activation, boolean::create_class(activation), script);
    ...
    avm2_system_class!(namespace, activation, namespace::create_class(activation), script);
    ...
    class(flash::media::sound::create_class(activation), script, activation)?;
    avm2_system_class!(
        soundtransform,
        activation,
    ...
    class(flash::text::font::create_class(activation), script, activation)?;
