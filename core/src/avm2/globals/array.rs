...
pub fn create_class<'gc>(activation: &mut Activation<'_, 'gc>) -> GcCell<'gc, Class<'gc>> {
    ...
    write.define_builtin_instance_methods(mc, activation.avm2().public_namespace(), PUBLIC_INSTANCE_METHODS);
    ...
    write.define_builtin_instance_properties(mc, activation.avm2().public_namespace(), PUBLIC_INSTANCE_PROPERTIES);
    ...
    write.define_builtin_instance_methods(mc, activation.avm2().as3_namespace(), AS3_INSTANCE_METHODS);
    ...
    write.define_constant_uint_class_traits(activation.avm2().public_namespace(), CONSTANTS, activation);
