...
pub fn create_class<'gc>(activation: &mut Activation<'_, 'gc>) -> GcCell<'gc, Class<'gc>> {
    ...
    write.define_builtin_instance_methods(gc_context, activation.avm2().as3_namespace(), AS3_INSTANCE_METHODS);
    ...
    write.define_builtin_instance_properties(gc_context, activation.avm2().public_namespace(), PUBLIC_INSTANCE_PROPERTIES);
