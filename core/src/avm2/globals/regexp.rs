...
pub fn create_class<'gc>(activation: &mut Activation<'_, 'gc>) -> GcCell<'gc, Class<'gc>> {
    ...
    let class = Class::new(
        ...
        Method::from_builtin_and_params(
            ...
            vec![
                ParamConfig::optional("re", Multiname::new(activation.avm2().public_namespace(), "String"), ""),
                ParamConfig::optional("flags", Multiname::new(activation.avm2().public_namespace(), "String"), ""),
            ],
            false,
            mc,
        ),
